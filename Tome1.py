...
helptranslate ="""
╠═════════════════
╠->➣[Id@en] แปล อิดโด/อังกฤษ
╠->➣[En@id] แปล อังกฤษ/อินโด
╠->➣[Id@jp] แปล อินโด/ญี่ปุ่น
╠->➣[Jp@id] แปล ญี่ปุ่น/อินโด
╠->➣[Id@th] แปล อินโด/ไทย
╠->➣[Th@id] แปล ไทย/อินโด
╠->➣[Id@ar]
╠->➣[Ar@id]
...
mid = cl.getProfile().mid
Bots=[mid,"u4db055855928255a6f53054d0915f196","uac0ea4ee97aadd105b6e1fb480de9708","","","","","","",""]
admin=["u4db055855928255a6f53054d0915f196","uac0ea4ee97aadd105b6e1fb480de9708","","","","","","","","","","",""]
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ ==  "u4db055855928255a6f53054d0915f196":
                    if "join:" in msg.text:
