...
cl = LINETCR.LINE()
cl.login(token="ErqWUcHnSFvHfOLQb5x6.xxQE/Oje5E8Oqo6g5tQJXG.7SnS7CMwspsX3Rnd5LX0bmQS5fO/QHsYijpYssvWZUo=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="ErlLaQgkC2dpTuf8qGA9.2E+cR7t8NqvHkpD1/oaqUq.rfQ5wYDHLXsAnv0XVy9BpA4vYMBqAOtfteasFtGLI3Q=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Erdul6wNfh6GmehNyBc2.mkBWeIFjC13ASC1470jn8G.AbkPDy9JGKrSSvG+b39Iz3vmeQyedWZ3m7Z/MNENpaU=")
ki2.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u5d7a9efa8244e5ef2840ee86e53aa3c6","ud9efc2afb4fc9d056128f775f8e010b9","u30a6f01227c9735ddab1cd78ef424df2",mid]
self = ["u5d7a9efa8244e5ef2840ee86e53aa3c6",mid]
admin = "u5d7a9efa8244e5ef2840ee86e53aa3c6"
admsa = "u5d7a9efa8244e5ef2840ee86e53aa3c6"
owner = "u5d7a9efa8244e5ef2840ee86e53aa3c6"
adminMID = "u5d7a9efa8244e5ef2840ee86e53aa3c6"
Creator="u5d7a9efa8244e5ef2840ee86e53aa3c6"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#                        ki10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        ...
                        ki1.sendText(msg.to,"[SELF BOT\ทBy:☬TOME↔BOTLINE☬ ]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[ By: ☬TOME↔BOTLINE☬ ]")
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดหมด","Tome All on","Phet all on"]:
                        cl.sendText(msg.to,"[SELF BOT]\n[By.☬🌷TOME↔BOTLINE🌷☬]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ปิดหมด","Tome All off","Phet all off"]:
                        cl.sendText(msg.to,"[SELFBOT]\n[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]")
                        cl.sendText(msg.to,"Please wait......")
