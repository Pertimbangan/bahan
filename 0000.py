...
cl =LINETCR.LINE()
cl.login(token="Es5Qw17zWmoWjHn27rXf.JT0XBzZvlkhD62MLklRnFW.TDOYBFu6y+UImVqI+ngPqQee/BuUCoTgmuMu2Xyhhjc=")
cl.loginResult()

ki1 =LINETCR.LINE()
ki1.login(token="EsQaGHubbstfZ6PnGM48.68uOSjAJA0e4sGy1KLJt2a.ULgojrxLIqKwBidPy7tDlqtcCqcpWsArtt2G0wQ0t7Y=")
ki1.loginResult()
...
╔═════════════════════
║ [By.☬ทีมงานเต๋า☬]
║  ติดต่อ [LINE ID :  ya2294]
╚═════════════════════
ลิ้ง:  http://line.me/ti/p/ya2294
──┅═✥===========✥═┅──
"""
helpMessage2 ="""
╔═════════════════════
...
║☬➣〘ปิดหมด〙
║☬➣〘เปิดหมด〙
║☬➣〘Protact on/off ป้องกัน ปิด\เปิด
║☬➣〘Qr on/off   ปิด	\เปิด  ลิ้ง
║☬➣〘Invit on/off〙
║☬➣〘Cancel on/off〙  
╚═══════════════════
...
Bots = ["u8edd316d9cd52ca1ddeb69a528bacd7f","uebc528b096a36b41384a06359258d3d8"]
admsa = "ue8ef8dee14f208e84ef2e1f19d8e54c0"
admin = "ub5e940d5b1aca5f2ba4260375f357ff9"
owner = "ucef59e3d2c06c523237c3ec87a127d8a"
adminMID = "ue5770f78f1b9312789188ccaf69953e8"
Creator="ue8ef8dee14f208e84ef2e1f19d8e54c0"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
""",
    ...
    "pname":{},
    "pro_name":{},
    "tag1":"\n[🔯แทคขนาดนี้จับปี้เลยดีกว่า🔯]",
    "tag2":"\n[🔯มาเเล้วคับจะเช่าเชลบอทหรอ",
	"posts":False,
	}
...
def bot(op):
    try:
        ...
        if op.type == 5:
            if wait["autodelete"] == True:
                if wait["autodelete"] == True:
                    cl.rejectGroup(op.param1)
                    ki1.rejectGroup(op.param1)
                    ki2.rejectGroup(op.param1)
                    ki3.rejectGroup(op.param1)
        if op.type == 11:
            if op.param3 == '1':
...
#===========================================
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ue8ef8dee14f208e84ef2e1f19d8e54c0":
                    if "join:" in msg.text:
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["💗แท้กบ่อยด๋วจับเยสรุย💗",cName + " 💟แทคเ���บบนี้จับเยสเลยดีกว่าม���ย💟",cName + " คับๆๆๆ","-_-","มาเเล้วคับ", cName + " งับบ","ไม่นะ " + cName, "ศรีสะเกษดีเชล " + cName, "ว่าไงคับ " + cName + "?", "มันดี " + cName + "?","มันทุกเม็ด","เเล้วเเต่เล���เจ้านาย"]
                     ret_ = "[(ღ¸.✻´`✻.¸¸ღ���¸.✻´`✻.¸¸ღღ¸.✻´`✻.¸¸ღ\n🌷เต๋า🌷 \n🌷จำหน่ายเซลบอท\n🌷บอทแท๊กประจำกลุ่ม\n🌷เซลบอทประจำตัว\n🌷เซลบอทกันรัน\n🌷รับปรึกษาปัญหาเรื่องบอท\n🌷เซลบอทประจำตัว ตัวละ300บาท\n🌷 ติดกันรัน ร่างละ150บาท\n🌷 เซลบอทแท๊คประจำกลุ่ม ดึงได้เฉพาะแอดมินชุดละ 400บาท\n🌷มีเซล Auto Block จำหน่าย\nคุณสมบัติ Bot Auto Block\n ป้องกันการรันห้องได้ 100%\nทุกครั้งที่มีการ @เพิ่มเพื่อน บอท  Auto Block\nจะทำงานอัตโนมัติ เพื่ิอป้องกันการรันห้อง กันได้\n100% รับประกัน\n****หมายเหตุ****[ก่อนจะแอด ทักในห้องก่อนนะครับ\nเพราะเวลาแอดมา บอทผมจะบร๊อคทันที\nทักหน้าแชตให้ผมรู้ก่อนครับ]\n   By เต๋าคับ   By เต๋าคับ   http://line.me/ti/p/_ya2294 ] " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["มาเเล้วคับ",cName + ""]
                     ret_ = "[คนนี้เเทค] " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                     for mention in mentionees:
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'ue8ef8dee14f208e84ef2e1f19d8e54c0'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/ya2294")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
            elif msg.text in ["คิกมา","มาหำ","#Kicker","#kicker","Kicker","บอทมา","•••"]:
                        ...
                        ki1.sendText(msg.to,"[SELF BOT\ทBy:☬ทีมงานเต๋า☬ ]")
                        ki2.sendText(msg.to,"[รับทำเชลบอทให้เช่า.]")
                        ki3.sendText(msg.to,"[ By: ☬ทีมงานเต๋า☬ ]")
...
#==================================================
                ...
                if msg.toType == 2:
                    ...
                    ki1.sendText(msg.to,"I pretended to cancel and canceled(๑و•��ω•́)و")
                    cl.sendText(msg.to,"I pretended to cancel and canceled(๑و•̀ω•́)و")
...
#===========================================#
#-----------------------------------------------------------
            elif msg.text in ["ลบเเชท","ลบแชท"]:  
                cl.removeAllMessages(op.param2)
                ki1.removeAllMessages(op.param2)
                ki2.removeAllMessages(op.param2)                  
                ki3.removeAllMessages(op.param2)
                cl.sendText(msg.to,"❇️กำลังลบข้อความเเชททั้งหมดอยุคับ❇️")
                ki1.sendText(msg.to,"❇️กำลังลบข้อความเเชททั้งหมดอยุคับ❇️")
                ki2.sendText(msg.to,"❇️กำลังลบข้อความเเชททั้งหมดอยุคับ❇️")
                ki3.sendText(msg.to,"❇️กำลังลบข้อความเเชททั้งหมดอยุคับ❇️")
               ...
               # gid = ki3.getGroupIdsInvited()
                ...
                if wait["lang"] == "JP":
                  ...
                  #  ki1.sendText(msg.to,"💟ทำการลบห้องรันหมดแล้ว💟")
                  #  ki2.sendText(msg.to,"💟ทำการลบห้อ���รันหมดแล้ว💟")
                   # ki3.sendText(msg.to,"💟ทำกา���ลบห���องรันหมดแล้ว💟")
                else:
                    cl.sendText(msg.to,"key is wrong。")
                    #ki1.sendText(msg.to,"key is wrong。")
                    #ki2.sendText(msg.to,"key is wrong。")
                    #ki3.sendText(msg.to,"key is wrong。")
   #----------------------------------------------------------------            
#=============================================#
                    ...
                    if AsulLogged == True:
                        ...
                        cl.sendText(msg.to,"ยังไม่ได้���็อคอิน")
#========================================#
                ...
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        ...
                        #ki2.sendText(msg.to,"Sudah off Bosqu")
                        #ki3.sendText(msg.to,"Sudah off Bosqu")
                    else:
                        cl.sendText(msg.to,"Ok Bosqu")
                        ki1.sendText(msg.to,"Ok Bosqu")
                        #ki2.sendText(msg.to,"Ok Bosqu")
                        #ki3.sendText(msg.to,"Ok Bosqu")
                else:
                    wait["autoAdd"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ok Bosqu")
                ...
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Ok ปิด เพิ่มเพื่อนให้เเล้ว")
                        ki1.sendText(msg.to,"Ok บอท 1 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
                        #ki2.sendText(msg.to,"Ok บอท 2 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
                        #ki3.sendText(msg.to,"Ok บอท 3 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
                else:
                    wait["autoAdd"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ok ปิด เพิ่มเพื่อนให้เเล้ว")
                        ...
                        #ki3.sendText(msg.to,"Sudah off Bosqu")
#=====================autodelete==========================#                        
            elif msg.text in ["ปิดลบ","เปิดกั","ปิดล","ปดลบ"]:
                if wait["autodelete"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                        ki1.sendText(msg.to,"Sudah off Bosqu")
                        ...
                        cl.sendText(msg.to,"Ok ได้ปิดลบออโต้เเล้ว")
                        ki1.sendText(msg.to,"Ok ได้ปิดลบออโต้เเล้ว")
                        #ki2.sendText(msg.to,"Ok Bosqu")
                        #ki3.sendText(msg.to,"Ok Bosqu")
                else:
                    wait["autodelete"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ok ได้ปิดลบออโต้เเล้ว")
                        ki1.sendText(msg.to,"Ok ได้ปิดลบออโต้เเล้ว")
                        #ki2.sendText(msg.to,"Ok Bosqu")
                        ...
                        #ki2.sendText(msg.to,"Sudah off Bosqu")
                        #ki3.sendText(msg.to,"Sudah off Bosqu")
            elif msg.text in [":off","off","ปิด","ลบ"]:
                if wait["autodelete"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah off Bosqu")
                        ki1.sendText(msg.to,"Sudah off Bosqu")
                        #ki2.sendText(msg.to,"Sudah off Bosqu")
                        ...
                        cl.sendText(msg.to,"Ok ได้เปิดลบออโต้เเล้ว")
                        ki1.sendText(msg.to,"Ok ได้เปิดลบออโต้เเล้ว")
                        #ki2.sendText(msg.to,"Ok บอท 2 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
                        #ki3.sendText(msg.to,"Ok บอท 3 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
                else:
                    wait["autodelete"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ok ได้เปิดลบออโต้เเล้ว")
                        ki1.sendText(msg.to,"Ok ได้เปิดลบออโต้เเล้ว")
                        #ki2.sendText(msg.to,"Ok บอท 2 ได้ปิดเพิ่มเพื่อนให้เเล้ว")
...
#-------------------------------------------------
                        ...
                        cl.sendText(msg.to,"ลบรัน")
                        cl.sendText(msg.to,"ปิด เพิ่มเพื่อน")
                        cl.sendText(msg.to,"")
            elif msg.text in ["เปิด"]:
                        cl.sendText(msg.to,"[SELF BOT]\n[By.☬ทีมงานเต๋า☬]")
                        cl.sendText(msg.to,"Please wait......")
                        cl.sendText(msg.to,"Turn on all protection")
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in ["ดีเต๋า","เต๋า","สวัสดีเต๋า","ดีเต่า","เต่า"]:
                        cl.sendText(msg.to,"คับผมเรียกมีไรคับ")   
                        cl.sendText(msg.to,"เต๋า")
            elif msg.text in ["คับเต๋า","งับเต๋า","คับเต่า","งับเต่า"]:
                        cl.sendText(msg.to,"คับผม")     
            elif msg.text in ["เงี่ยน","เงี่ยนจัง","เงี่ยนๆ","เงี่ยนมาห","เงี่ยนเงี่ยน","เงี่ยนน"]:
                        cl.sendText(msg.to,"เงี่ยนจะให้ทำยังไงคับ")            
            elif msg.text in ["กำ","กรรม","กำหำ","กำหอย","กรรมหำ","กำกำ"]:
                        cl.sendText(msg.to,"กำอยุได้ปล่อยบ้างก็ได้นะเด๋วจะเหนื่อย")
            elif msg.text in ["55","555","5555","5555","55555","555555"]:
                        cl.sendText(msg.to,"ขำอยุได้เมากาวหรอคับ")
            elif msg.text in ["อิ","อิอิ","อิอิอิ","อิอิๆ","อิอ"]:
                        cl.sendText(msg.to,"อิอิหมายความว่ายังไง")       
            elif msg.text in ["ไปล","ไปละ","ไปล่ะ","ไปนะ","บาย","บายๆ"]:
                        cl.sendText(msg.to,"บายๆลาก่อนคับโชคดีนะ") 
            elif msg.text in ["me","Me","ME","คท","sp","SP","Help","help","คำสั่ง"]:
                        cl.sendText(msg.to,"เชคทั้งวันกลัวหลุดหรอคับ") 
                        ki1.sendText(msg.to,"เชคสมองด้วยเป็นบ้าเเล้ว")
                        ki2.sendText(msg.to,"ใช่เชคทั้งวันไม่ทำงานกันไง")
                        ki3.sendText(msg.to,"เชคทั้งวันเครื่องผมจะพังอยุเเล้ว")
            elif msg.text in ["คท"]:
                        cl.sendText(msg.to,"😆เช็คจัง กลัวบอทหลุด ล่ะสิ😆")

            elif msg.text in ["เทสบอท","เทส"]:
                        cl.sendText(msg.to,"SELF BOT\n[By.☬ทีมงานเต๋า☬]")
            elif msg.text in ["You...","You....","You....."]:
                        cl.sendText(msg.to,"You..อะไ​ร")

            elif msg.text in [".อยู่ไหม"]:
                        cl.sendText(msg.to,"อยู่...")
            elif msg.text in ["ปิด เพิ่มเพื่อน","ปิดเพิ่ม"]:
                        cl.sendText(msg.to,"ปิด เพิ่มเพื่อน")
            elif msg.text in ["เปิด เพิ่มเพื่อน","เปิดเพิ่ม"]:
                        cl.sendText(msg.to,"เปิด เพิ่มเพื่อน")		
...
#==============================================================================#
        if op.type == 17:
          if wait["Notifed"] == True:
            ...
            image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1,"•Hello ↪️" + cl.getContact(op.param2).displayName + "↩️\n•Welcome To 🔛 " + str(ginfo.name) + " " + "\n•by : SELFBOT_MAN_PROTECT")
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            cl.sendMessage(c) 
